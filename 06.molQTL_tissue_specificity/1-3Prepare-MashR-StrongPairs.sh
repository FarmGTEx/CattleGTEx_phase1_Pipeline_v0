...
python3 /faststorage/project/farmgtex/pipeline/code/mashR/mashr_prepare_input.py ${dir_output}/strong_pairs_files.txt strong_pairs -o ${dir_output} --only_zscore
