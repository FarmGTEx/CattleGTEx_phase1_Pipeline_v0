...
type <-  ARGS[2]
file_tpm <- "/faststorage/project/farmgtex/pipeline/internal_validation/" %&% scenario_select %&% "/" %&% type %&% "/TPM_QTL.rds"
file_counts <- "/faststorage/project/farmgtex/pipeline/internal_validation/" %&% scenario_select %&% "/" %&% type %&% "/count_QTL.rds"
